...
object Settings {
  ...
  object Data {
    ...
    object Write {
      ...
      val bestSellingHours: String = write.getString("bestSellingHours")
      val discount: String = write.getString("discount")
      val clientDistr: String = write.getString("clientDistr")
    }
  }
}
